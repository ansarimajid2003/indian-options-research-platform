# Risk Management Experiments - 20260505_risk_mgmt_smoke
...
| Naked old Port A | `BANKNIFTY:1 MIDCPNIFTY:7` | strangle | 1,413 | +INR 1,809,815 | +27.58% | 1.827 | -14.62% | 1.502 | -INR 36,959 | +INR 673,271 | 1.341 | unlimited |
| Naked old Port B | `BANKNIFTY:2 MIDCPNIFTY:5` | strangle | 1,413 | +INR 1,450,978 | +23.54% | 1.764 | -17.11% | 1.415 | -INR 29,760 | +INR 456,675 | 1.251 | unlimited |
...
| Naked risk-parity skip 10-13 | `NIFTY:2 BANKNIFTY:2 FINNIFTY:2 MIDCPNIFTY:2` | strangle | 1,846 | +INR 991,390 | +17.64% | 1.168 | -18.35% | 1.315 | -INR 38,230 | +INR 355,885 | 1.268 | unlimited |
...
- Portfolio table: `20260505_risk_mgmt_smoke_portfolio_comparison.csv`
- VIX bucket attribution: `20260505_risk_mgmt_smoke_vix_bucket_attribution.csv`
- Report: `20260505_risk_mgmt_smoke_risk_management_experiments.md`