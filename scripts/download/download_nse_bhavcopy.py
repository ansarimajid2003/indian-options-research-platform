...
Output layout:
  data/raw/nse/bhavcopy/fo/{YYYY}/{YYYYMMDD}.csv   (extracted, one file per trading day)

Usage:
  python scripts/download/download_nse_bhavcopy.py                          # last 30 days
  python scripts/download/download_nse_bhavcopy.py --from-date 2015-01-01  # full backfill
  python scripts/download/download_nse_bhavcopy.py --from-date 2020-01-01 --to-date 2020-12-31
  python scripts/download/download_nse_bhavcopy.py --dry-run                # count files, no download
"""
...
DEFAULT_OUTPUT_DIR = ROOT / "data" / "raw" / "nse" / "bhavcopy" / "fo"
