...
from market_data.data_loader import load_nifty_15min  # noqa: E402  (after stdlib imports)
OUT_DIR = Path("reports") / "research" / "nifty_3pm"
...
Machine-readable CSVs remain one folder up in `reports/research/nifty_3pm/`.
"""
