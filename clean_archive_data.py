...
Raw files under archive/ are treated as the source of truth and are never
modified. Cleaned files are written to cleaned_archive/, and audit reports are
written to data_quality_reports/.
...
CLEAN_DIR = ROOT / "cleaned_archive"
REPORT_DIR = ROOT / "data_quality_reports"
NIFTY_RECENT_FILE = ROOT / "nifty50_1m_recent_7days.csv"
NIFTY_CANONICAL_FILE = ROOT / "nifty50_1min_CANONICAL.csv"
