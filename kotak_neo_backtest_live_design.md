...
1. Update `kotak_neo_setup.md` and `kotak_neo_live_collector.py` to use the v2
   install path:
...
4. Keep historical backtests on the local cleaned archive plus any other approved
